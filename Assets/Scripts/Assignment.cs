...
public class Assignment : MonoBehaviour
{
    ...
    public void As10_CalculateWeaponDamage()
    {
        ...
        switch (as10WeaponType?.ToLower()) //ไม่คำนึงตัวเล็กใหญ่ โดยการทำให้เป็นตัวเล็กทุกกรณีด้วยToLower
        {
            case "sword":
                multiplier = 1.3;
                break;
        ...
        int totalDamage = (int)(as10BaseDamage * multiplier);//แปลงผลลัพธ์ให้เป็น int
