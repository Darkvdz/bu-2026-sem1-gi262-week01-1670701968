...
public class Assignment : MonoBehaviour
{
    ...
    public void As10_CalculateWeaponDamage()
    {
        ...
        switch (as10WeaponType?.ToLower()) //äÁè¤Ó¹Ö§µÑÇàÅç¡ãË­è â´Â¡ÒÃ·ÓãËéà»ç¹µÑÇàÅç¡·Ø¡¡Ã³Õ´éÇÂToLower
        {
            case "sword":
                multiplier = 1.3;
                break;
        ...
        int totalDamage = (int)(as10BaseDamage * multiplier);//á»Å§¼ÅÅÑ¾¸ìãËéà»ç¹ int
